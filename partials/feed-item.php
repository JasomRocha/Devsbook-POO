            ...
            <?php if($item->mine):?>
                <div class="feed-item-head-btn">
                    ...
                    <div class="feed-item-more-window">
                        <a href="/excluir_post_action.php?id=<?=$item->id?>">Excluir Post</a>
                    </div>
                </div>
            <?php endif;?>
        </div>
        <div class="feed-item-body mt-10 m-width-20">
            ...
            <?php switch($item->type){
                case 'text':
                    ...
                    break;
                case 'photo':
                    echo '<img src="media/uploads/' . $item->body . '" />';
                    break;
            }?>
        </div>
                    ...
                    <?php foreach($item->comments as $comment):?>
                        <div class="fic-item row m-height-10 m-width-20">
                            <div class="fic-item-photo">
                                <a href="/perfil.php?id=<?=$comment->user->id?>"><img src="media/avatars/<?= $comment->user->avatar ?>" /></a>
                            </div>
                            <div class="fic-item-info">
                                <a href="/perfil.php?id=<?=$comment->user->id?>"><?= $comment->user->name ?></a>
                                <?= $comment->body?>
                            </div>
                        </div>
                    <?php endforeach; ?>
